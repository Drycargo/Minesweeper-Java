...
public class ms extends JFrame {
    ...
    public boolean lose = false;//同时表示胜利和结束
    ...
    public ms() {
        ...
        JMenu GAME = new JMenu("Game");//菜单栏&菜单
        mb.add(GAME);

        JMenuItem NG = new JMenuItem("New Game");//新游戏
        ...
        if (dimensions[0] == 9 && dimensions[1] == 9 && dimensions[2] == 10)//确定模式
        {
            mode = 0;
